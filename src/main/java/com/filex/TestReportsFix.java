...
public class TestReportsFix {
    public static void main(String[] args) {
        System.out.println("Testing Reports fix...");
        ...
        try {
            ...
            System.err.println("Error testing reports fix: " + e.getMessage());
            e.printStackTrace();
        }
        
        System.out.println("Reports fix test completed.");
    }
}